const describeSchemas = {
  ...
  SchemaArn:
    "arn:aws:schemas:us-west-1:312708401777:schema/discovered-schemas/users@UserCreated",
...
const listSchemas = {
  Schemas: [
    ...
    },
    {
      LastModified: "2022-01-20T06:58:30.000Z",
      SchemaArn:
        "arn:aws:schemas:us-west-1:312708401777:schema/discovered-schemas/users@UserDeleted",
