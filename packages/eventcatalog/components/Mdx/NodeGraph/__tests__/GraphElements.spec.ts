...
describe("GraphElements", () => {
  describe("getServiceElements", () => {
    it("takes a given Service and returns the ReactFlow elements with relations the events it publishes and consumes", () => {
      ...
      const result = getServiceElements(
        service as Service,
        rootNodeColor,
        isAnimated,
      );
    ...
    it("takes a given Service and returns the ReactFlow elements with multiple events & long names", () => {
      ...
      const event4 = {
        name: "very.very.very.very.very.very.very.very.very.very.very.very.long.name.event.4",
        version: "0.0.1",
      };
      const event5 = {
        name: "very very very very very very very very very very very very long name event 5",
        version: "0.0.1",
      };
